...
UGameUserSettings::UGameUserSettings() {
    ...
    this->DesiredScreenWidth = 1920;
    this->bUseDesiredScreenHeight = false;
    this->DesiredScreenHeight = 1080;
    this->LastUserConfirmedDesiredScreenWidth = 1920;
    this->LastUserConfirmedDesiredScreenHeight = 1080;
    this->LastRecommendedScreenWidth = -1.00f;
    this->LastRecommendedScreenHeight = -1.00f;
    this->LastCPUBenchmarkResult = 200.48f;
    this->LastGPUBenchmarkResult = 223.57f;
