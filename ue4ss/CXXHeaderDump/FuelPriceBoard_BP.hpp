#ifndef UE4SS_SDK_FuelPriceBoard_BP_HPP
#define UE4SS_SDK_FuelPriceBoard_BP_HPP

class AFuelPriceBoard_BP_C : public AFuelPriceBoard
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x05F0 (size: 0x8)
    class UStaticMeshComponent* sign_back;                                            // 0x05F8 (size: 0x8)
    class USpotLightComponent* SpotLight;                                             // 0x0600 (size: 0x8)
    ...
    void ExecuteUbergraph_FuelPriceBoard_BP(int32 EntryPoint);
}; // Size: 0x640
