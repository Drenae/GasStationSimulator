...
{
    TArray<UMovieSceneSection*> ConstraintSections;                                   // 0x0090 (size: 0x10)
...
{
    TArray<UMovieSceneSection*> AudioSections;                                        // 0x0098 (size: 0x10)
...
{
    TArray<UMovieSceneSection*> CameraAnimSections;                                   // 0x0098 (size: 0x10)
...
{
    TArray<UMovieSceneSection*> CameraShakeSections;                                  // 0x0098 (size: 0x10)
...
{
    TArray<UMovieSceneSection*> ParticleSections;                                     // 0x0098 (size: 0x10)
...
{
    TArray<UMovieSceneSection*> AnimationSections;                                    // 0x0098 (size: 0x10)
