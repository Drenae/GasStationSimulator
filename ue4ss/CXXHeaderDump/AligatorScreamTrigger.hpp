#ifndef UE4SS_SDK_AligatorScreamTrigger_HPP
#define UE4SS_SDK_AligatorScreamTrigger_HPP

class AAligatorScreamTrigger_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class UBoxComponent* Box;                                                         // 0x0228 (size: 0x8)
    class UBoxComponent* Overlap;                                                     // 0x0230 (size: 0x8)
    ...
    void ExecuteUbergraph_AligatorScreamTrigger(int32 EntryPoint);
}; // Size: 0x238
