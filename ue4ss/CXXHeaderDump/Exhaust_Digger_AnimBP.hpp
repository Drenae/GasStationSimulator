#ifndef UE4SS_SDK_Exhaust_Digger_AnimBP_HPP
#define UE4SS_SDK_Exhaust_Digger_AnimBP_HPP

class UExhaust_Digger_AnimBP_C : public UAnimInstance
{
    ...
    bool DoWeDrive?;                                                                  // 0x0558 (size: 0x1)

    void AnimGraph(FPoseLink& AnimGraph);
    void BlueprintUpdateAnimation(float DeltaTimeX);
    void ExecuteUbergraph_Exhaust_Digger_AnimBP(int32 EntryPoint);
}; // Size: 0x559
