#ifndef UE4SS_SDK_BP_RVCampTrapdoor_HPP
#define UE4SS_SDK_BP_RVCampTrapdoor_HPP

class ABP_RVCampTrapdoor_C : public ATrapDoor
{
    ...
    void OnCantTeleport();
    void ExecuteUbergraph_BP_RVCampTrapdoor(int32 EntryPoint);
}; // Size: 0x298
