#ifndef UE4SS_SDK_ThrowMiniGame_Score_HPP
#define UE4SS_SDK_ThrowMiniGame_Score_HPP

class UThrowMiniGame_Score_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_ThrowMiniGame_Score(int32 EntryPoint);
}; // Size: 0x2E4
