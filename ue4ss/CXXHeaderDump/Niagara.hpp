...
{
    TMap<FNiagaraVariable, FNiagaraVariable> UserParameterRedirects;                  // 0x0078 (size: 0x50)
...
struct FNiagaraVariableMetaData
{
    ...
    TMap<FName, FString> PropertyMetaData;                                            // 0x0070 (size: 0x50)
...
class ANiagaraPreviewGrid : public AActor
{
    ...
    TArray<UChildActorComponent*> PreviewComponents;                                  // 0x0258 (size: 0x10)
...
{
    TArray<UMovieSceneSection*> Sections;                                             // 0x0090 (size: 0x10)
...
class UNiagaraEmitter : public UObject
{
    ...
    TArray<UNiagaraRendererProperties*> RendererProperties;                           // 0x0180 (size: 0x10)
    TArray<FNiagaraEventScriptProperties> EventHandlerScriptProps;                    // 0x0190 (size: 0x10)
    TArray<UNiagaraSimulationStageBase*> SimulationStages;                            // 0x01A0 (size: 0x10)
...
class UNiagaraScript : public UNiagaraScriptBase
{
    ...
    TArray<UNiagaraParameterCollection*> CachedParameterCollectionReferences;         // 0x02B8 (size: 0x10)
...
class UNiagaraSettings : public UDeveloperSettings
{
    ...
    TMap<FString, FText> ComponentRendererWarningsPerClass;                           // 0x0060 (size: 0x50)
...
class UNiagaraSystem : public UFXSystemAsset
{
    ...
    TArray<UNiagaraParameterCollectionInstance*> ParameterCollectionOverrides;        // 0x0078 (size: 0x10)
