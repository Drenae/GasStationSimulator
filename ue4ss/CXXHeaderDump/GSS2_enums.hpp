...
enum class EBBQSelectSlotDirection {
    NONE = 0,
    UP = 1,
    DOWN = 2,
    RIGHT = 3,
...
enum class EBarCustomerNativeType {
    None = 0,
...
enum class EBaseWidgetFocusType {
    Focused = 0,
    NotFocused = 1,
    Any = 2,
    MAX = 3,
...
enum class EBuildingPathStationState {
    OPEN = 0,
    CLOSED = 1,
    NOT_ACQUIRED = 2,
    MAX = 3,
...
enum class ECamperWashingEfficiency {
    NORMAL = 0,
    ECO = 1,
    ECamperWashingEfficiency_MAX = 2,
};

enum class ECarPartStat {
    ACCELERATION = 0,
    TOP_SPEED = 1,
    HANDLING = 2,
    STRENGTH = 3,
...
enum class ECarWreckMarkingError {
    DEFAULT = 0,
...
enum class ECarWreckPlaceableAreaType {
    WRECKS_SPOT = 0,
    SHREDDER = 1,
    PLATFORM = 2,
    EXHIBITION_SPOT = 3,
...
enum class EChunchumanchuAnger {
    HAPPY = 0,
    LOW = 1,
    HIGH = 2,
    ERUPTION = 3,
...
enum class ECircularMenuChoice {
    HAND = 0,
    BROOM = 1,
    VACUUM_GUN = 2,
    TRASH_BAG = 3,
...
enum class EContainerAnimation {
    NO_ANIM = 0,
    CONTAINER_UP = 1,
    CONTAINER_DOWN = 2,
    SPOONT_TO_CONE = 3,
...
enum class EContractDifficulty {
    EASY = 0,
    MEDIUM = 1,
    HARD = 2,
    MAX = 3,
...
enum class EContractPaintRequirement {
    COLOR = 0,
    FINISH_TYPE = 1,
    PAINT_TYPE = 2,
    MAX = 3,
...
enum class EContractRequirement {
    CAR_WRECK_CLASS = 0,
    CAR_WRECK_TIER = 1,
    CAR_PARTS_TIER = 2,
    CAR_PARTS_CLASS = 3,
...
enum class ECountableObjectiveDisplayType {
    REGULAR = 0,
    TIME = 1,
    MAX = 2,
};

enum class ECountryOfOrigin {
    NONE = 0,
    Mexico = 1,
    Cuba = 2,
    Brazil = 3,
...
enum class ECustomTextVariableType {
    ECTVT_SavedServiceName = 0,
    ECTVT_SomeOtherNonsense = 1,
    MAX = 2,
};

enum class ECustomerType {
    FUEL = 0,
    REPAIR = 1,
    CAR_WASH = 2,
    SHOPPING = 3,
...
enum class ECustomizationContractType {
    REGULAR = 0,
    VIP = 1,
    RACE = 2,
    DESTRUCTION_DERBY = 3,
...
enum class ECustomizationPaintType {
    NONE = 0,
    STRIPES = 1,
    FLAMES = 2,
    FLOWERS = 3,
...
enum class EDecalColor {
    Generic = 0,
    Artistic = 1,
    EDecalColor_MAX = 2,
};

enum class EDecalSprayingState {
    PLACING = 0,
    CLEANING = 1,
    PAINTING = 2,
    MAX = 3,
...
enum class EDecalType {
    PaintedDecal = 0,
    DirtyDecal = 1,
    EDecalType_MAX = 2,
};

enum class EDecalUnlockType {
    All = 0,
    Pictograms = 1,
    Frames = 2,
    Scribbles = 3,
...
enum class EDecorationCameraType {
    NORMAL_DECORATION = 0,
...
enum class EDialogueClass {
    STORY = 0,
    BARK = 1,
    MAX = 2,
};

enum class EDialogueSpeaker {
    ANY = 0,
    PRIMARY = 1,
    SECONDARY = 2,
    MAX = 3,
...
enum class EDishPlacementResult {
    SUCCESS = 0,
    INVALID_DISH = 1,
    DIRTY_DISH = 2,
    WRONG_DISH_STACK = 3,
...
enum class EDishwashingEfficiency {
    NORMAL = 0,
    ECO = 1,
    ECO_PLUS = 2,
...
enum class EDriverCarState {
    Inside = 0,
    Outside = 1,
    EDriverCarState_MAX = 2,
};

enum class EDumbbellContainerType {
    STAND = 0,
    GRIFFIN = 1,
    EDumbbellContainerType_MAX = 2,
};

enum class EEconomyDetailedYieldType {
    PRODUCTS = 0,
    GAS = 1,
    CAR_PARTS = 2,
    DECORATIONS = 3,
...
enum class EEconomyGeneralYieldType {
    REVENUE = 0,
    COST = 1,
    NOT_RELEVANT = 2,
    MAX = 3,
...
enum class EFameRewardCategory {
    COLORS = 0,
    DECALS = 1,
    PAINT_STYLES = 2,
    PAINT_TYPES = 3,
...
enum class EFuelMagazine {
    GAS_STATION = 0,
    AIRPORT = 1,
    EFuelMagazine_MAX = 2,
};

enum class EFuelState {
    IsOk = 0,
    NoOk = 1,
    NoFuel = 2,
    EFuelState_MAX = 3,
...
enum class EGarageNotification {
    BROKEN_MIRROR = 0,
    BROKEN_DOOR = 1,
    BROKEN_WHEEL = 2,
    BROKEN_SPARKPLUG = 3,
...
enum class EGlobalStationEvent {
    STATION_CLOSED = 0,
    VOLCANO_ERUPTION = 1,
    UFO = 2,
    MAX = 3,
...
enum class EGuestServiceDifficulty {
    EASY = 0,
    MEDIUM = 1,
    HARD = 2,
    MAX = 3,
...
enum class EGuestServiceLocationType {
    CAMP_SPOT = 0,
    RV_BUILDING = 1,
    GAS_STATION = 2,
    MAX = 3,
...
enum class EIceCreamMakingState {
    DEFAULT = 0,
    PLACING_CONE = 1,
    MAKING_SCOOP = 2,
...
enum class EIceCreamPadTargetSection {
    UPPER_SECTION = 0,
...
enum class EIceCreamPadTargetType {
...
enum class EInteractableTaskType {
...
enum class EInteractionOutput {
    Pressed = 0,
    Released = 1,
    EInteractionOutput_MAX = 2,
};

enum class EInteractionPrefix {
    CLICK = 0,
    HOLD = 1,
    RELEASE = 2,
    PRESS = 3,
...
enum class EInteractionPriority {
    First = 0,
    Second = 1,
    Third = 2,
...
enum class EInventoryChildType {
    BasicInventory = 0,
    AltarInventory = 1,
...
enum class EItemIconVisibility {
    VISIBLE = 0,
    NOT_ENOUGH_LEVEL = 1,
    NOT_READY = 2,
    NONE = 3,
...
enum class EJoeOrderType {
    BLUEPRINT = 0,
    MONEY = 1,
    MAX = 2,
};

enum class EJoeSittingState {
    Breathing = 0,
    Drinking = 1,
    Smoking = 2,
    MAX = 3,
...
enum class EJoeTasksPlaces {
    BENCH = 0,
    MAX = 1,
};

enum class EJunkyardCarPartType {
    FRONTBUMPER = 0,
    REARBUMPER = 1,
    LEFTDOOR = 2,
    RIGHTDOOR = 3,
...
enum class EJunkyardCarWreckType {
    CAR1 = 0,
    CAR2 = 1,
    CAR3 = 2,
    CAR4 = 3,
...
enum class EJunkyardDecalPossibility {
    PAINTABLE = 0,
    RUSTY = 1,
    NOTPAINTABLE = 2,
    MISSINGPARTS = 3,
...
enum class EJunkyardPartRarity {
    FAKE = 0,
    SUBSTITUTE = 1,
    ORIGINAL = 2,
    NONE = 3,
...
enum class ELeaderboardDataType {
    Global = 0,
    GlobalAroundUser = 1,
    Friends = 2,
    Users = 3,
...
enum class EMagnetDetachErrorReason {
    DEFAULT = 0,
...
enum class EMarshalWandsMinigameDifficulty {
    EASY = 0,
    MEDIUM = 1,
    HARD = 2,
    MAX = 3,
...
enum class EMeshMovementDirection {
    FORWARD = 0,
    BACK = 1,
    MAX = 2,
};
...
enum class EMirrorSide {
    LEFT = 0,
    RIGHT = 1,
    MAX = 2,
};

enum class EMoneyType {
    Normal = 0,
    Fuel = 1,
    Cash = 2,
    Garage = 3,
...
enum class EMontageCancelReason {
    NewTask = 0,
    Dialog = 1,
    MAX = 2,
};

enum class EMontagePilotState {
    Mounted = 0,
    Mounting = 1,
    UnMounted = 2,
    UnMounting = 3,
...
enum class EMovementGroundType {
    Walk = 0,
    Jog = 1,
    Run = 2,
    Dance_1 = 3,
...
enum class ENPCConversationType {
    GREETING = 0,
    FAREWELL = 1,
    TRADING = 2,
    TRADE_HOLD = 3,
...
enum class ENozzleRotation {
    HORIZONTAL = 0,
    VERTICAL = 1,
    ENozzleRotation_MAX = 2,
};

enum class ENumberOfDancingNPC {
    One = 0,
    Three = 1,
    Six = 2,
    Eight = 3,
...
enum class EPriceBoardInteractionType {
    FromWorld = 0,
    FromPC = 1,
    MAX = 2,
};

enum class EPriorityTraffic {
    Vehicle = 0,
    CarWash = 1,
    Cinema = 2,
    MAX = 3,
...
enum class EProductCashShopState {
    TO_SCAN = 0,
    ON_BELT = 1,
    SCANNED = 2,
    MAX = 3,
...
enum class EProductVectorPointType {
    BUY_PRICE = 0,
    SELL_PRICE = 1,
    AVG_PRICE = 2,
    MAX = 3,
...
enum class ERVCamperLeftReason {
    FULFILLED = 0,
    DISMISSED = 1,
    MAX = 2,
};

enum class ERVCamperState {
    ARRIVING = 0,
    PARKED = 1,
    LEAVING = 2,
    MAX = 3,
...
enum class ERVChallengeTimeTrackType {
    ETT_UNLIMITED = 0,
    ETT_Hours = 1,
    ETT_WholeTurnout = 2,
    ETT_MAX = 3,
...
enum class ERVMinigameCameraBlendOutMode {
    END_MINIGAME = 0,
    LATE_END_MINIGAME = 1,
    ERVMinigameCameraBlendOutMode_MAX = 2,
};

enum class ERVMinigameStage {
    INACTIVE = 0,
    EARLY = 1,
    NORMAL = 2,
    POST_END = 3,
...
enum class ERVUpgradableBuilding {
    CAMP_SPOT = 0,
    SERVICE = 1,
    RESOURCE = 2,
    OFFICE = 3,
...
enum class ERefuelObjectiveType {
    LESS = 0,
    NEARLY_EQUALS = 1,
    MORE = 2,
    MAX = 3,
...
enum class ERelativeDirectionReturnAmount {
    TWO = 0,
    FOUR = 1,
    EIGHT = 2,
    MAX = 3,
...
enum class ERelativeDistance {
    ERD_CLOSEST = 0,
    ERD_FARTHEST = 1,
    ERD_MAX = 2,
};

enum class ERenown_Reasons {
    SHOP_CUSTOMER_SERVED = 0,
    FUEL_CUSTOMER_SERVED = 1,
    CARS_WASHED = 2,
...
enum class ESDFightClubAttackResult {
    DamageDealt = 0,
    DamageNegated = 1,
    DamageAvoided = 2,
    KnockOut = 3,
...
enum class ESDFightClubWinReason {
    None = 0,
    EnemyKnockOut = 1,
    JudgesPoints = 2,
    MAX = 3,
...
enum class ESDFirePitMeatStatus {
    None = 0,
    Raw = 1,
    Cooked = 2,
    Burnt = 3,
...
enum class ESDGangActivityResult {
    Success = 0,
    Fail = 1,
    CriticalFail = 2,
    CaughtFail = 3,
...
enum class ESDGangActivityType {
    FightClub = 0,
    Conference = 1,
    ParkingMeet = 2,
    Warehouse = 3,
...
enum class ESDMinigameEndReason {
    Success = 0,
    TimeOut = 1,
    CrucialActorLost = 2,
    Cancel = 3,
...
enum class ESDPenaltyType {
    LastDayIncomePercent = 0,
    FixedPenalty = 1,
    MAX = 2,
};

enum class ESDShadynessModifierPersistance {
    Instant = 0,
    Duration = 1,
    ESDShadynessModifierPersistance_MAX = 2,
};

enum class ESeanTaskBark {
    NONE = 0,
    FIXING_ENGINE = 1,
    SITTING_IN_OFFICE = 2,
    MOVING_WRECK = 3,
...
enum class EShelfSize {
    BIG_SHELVE = 0,
    SMALL_SHELVE = 1,
    EShelfSize_MAX = 2,
};

enum class EShelfType {
    ShopShelf = 0,
    GarageShelf = 1,
    TapeShelf = 2,
    PartyShelf = 3,
...
enum class EShootingRangeDifficulty {
    StandUp = 0,
    Movable = 1,
    ZigZag = 2,
    UFO = 3,
...
enum class ESpecialCharacterType {
    DEFAULT = 0,
    VIP = 1,
    MAX = 2,
};

enum class ESpiderPositionType {
    NONE = 0,
    WEB_STANDING = 1,
    WEB_WALL = 2,
    WEB_WALL_01 = 3,
...
enum class ETradingCenterUpgrade {
    HEADQUATERS = 0,
    RADIO_TOWER = 1,
    COM_CENTER = 2,
    MAX = 3,
...
enum class EUnlockableGameplayStuffState {
    LOCKED = 0,
    UNLOCKED = 1,
    MAX = 2,
};

enum class EUnlockableUIState {
    HIDDED = 0,
    LOCKED = 1,
    UNLOCKED = 2,
    MAX = 3,
...
enum class EUpgradeBuildingType {
    GAS_STATION = 0,
    WAREHOUSE = 1,
    WORKSHOP = 2,
    CAR_WASH = 3,
...
enum class EVehicleMovementState {
    Move = 0,
    Block = 1,
    EVehicleMovementState_MAX = 2,
};

enum class EVehicleOptymalizeType {
    Default = 0,
    Fuel = 1,
    Repair = 2,
    CarWash = 3,
...
enum class EWarehouseAdditionalFeautures {
    AutomaticValve = 0,
    EWarehouseAdditionalFeautures_MAX = 1,
};

enum class EWheelSide_FourWheel {
    FRONT_LEFT = 0,
    FRONT_RIGHT = 1,
    BACK_LEFT = 2,
    BACK_RIGHT = 3,
...
enum class eCinemaProjectorState {
    READY = 0,
    INPROGRESS = 1,
...
enum class eDialogueRequirement {
    MAX = 0,
};
...
enum class ePopcornMachineState {
    READY = 0,
    INPROGRESS = 1,
    ePopcornMachineState_MAX = 2,
};

enum class eTicketParameters {
    DIGIT_ID = 0,
    MOVIE_NAME = 1,
    CINEMA_NAME = 2,
    FILM_IMAGE = 3,
