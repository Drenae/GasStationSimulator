#ifndef UE4SS_SDK_ProductsTruck_BP_HPP
#define UE4SS_SDK_ProductsTruck_BP_HPP

class AProductsTruck_BP_C : public A00_Vehicle_C
{
    ...
    void OnLoaded_027676514C2855B37D9B9081FA931BDE(UClass* Loaded);
    ...
    void ExecuteUbergraph_ProductsTruck_BP(int32 EntryPoint);
}; // Size: 0x640
