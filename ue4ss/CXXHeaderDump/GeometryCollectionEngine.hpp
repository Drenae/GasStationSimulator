...
struct FGeometryCollectionSource
{
    ...
    TArray<UMaterialInterface*> SourceMaterial;                                       // 0x0050 (size: 0x10)
...
class UGeometryCollection : public UObject
{
    ...
    TArray<UMaterialInterface*> RemoveOnFractureMaterials;                            // 0x00C0 (size: 0x10)
...
class UGeometryCollectionComponent : public UMeshComponent
{
    ...
    TArray<AFieldSystemActor*> InitializationFields;                                  // 0x0570 (size: 0x10)
...
class UStaticMeshSimulationComponent : public UActorComponent
{
    ...
    void OnChaosPhysicsCollision(const FChaosPhysicsCollisionInfo& CollisionInfo);
    TArray<UPrimitiveComponent*> SimulatedComponents;                                 // 0x0120 (size: 0x10)
