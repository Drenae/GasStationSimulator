#ifndef UE4SS_SDK_TowyResetButton_BP_HPP
#define UE4SS_SDK_TowyResetButton_BP_HPP

class ATowyResetButton_BP_C : public AActor
{
    ...
    void ExecuteUbergraph_TowyResetButton_BP(int32 EntryPoint);
}; // Size: 0x238
