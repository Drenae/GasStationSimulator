#ifndef UE4SS_SDK_WBP_ShowQuestHolder_HPP
#define UE4SS_SDK_WBP_ShowQuestHolder_HPP

class UWBP_ShowQuestHolder_C : public UUserWidget
{
    ...
    class UImage* Image_84;                                                           // 0x0280 (size: 0x8)
    class UImage* ProgressBar;                                                        // 0x0288 (size: 0x8)
    ...
    void ExecuteUbergraph_WBP_ShowQuestHolder(int32 EntryPoint);
}; // Size: 0x2AC
