...
{
    TArray<ULevelSequence*> ImportedSequences;                                        // 0x0220 (size: 0x10)
...
class ADatasmithSceneActor : public AActor
{
    ...
    TMap<FName, TSoftObjectPtr<class AActor>> RelatedActors;                          // 0x0228 (size: 0x50)
...
class UDatasmithAreaLightActorTemplate : public UDatasmithObjectTemplate
{
    ...
    TSoftObjectPtr<class UTextureLightProfile> IESTexture;                            // 0x0058 (size: 0x28)
...
class UDatasmithSceneComponentTemplate : public UDatasmithObjectTemplate
{
    ...
    TSoftObjectPtr<class USceneComponent> AttachParent;                               // 0x0068 (size: 0x28)
