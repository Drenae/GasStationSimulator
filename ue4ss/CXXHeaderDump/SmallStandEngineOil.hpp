#ifndef UE4SS_SDK_SmallStandEngineOil_HPP
#define UE4SS_SDK_SmallStandEngineOil_HPP

class ASmallStandEngineOil_C : public A00_Stand_C
{
    ...
    void ExecuteUbergraph_SmallStandEngineOil(int32 EntryPoint);
}; // Size: 0x730
