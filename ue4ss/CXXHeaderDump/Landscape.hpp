...
class ALandscapeProxy : public AActor
{
    ...
    TArray<URuntimeVirtualTexture*> RuntimeVirtualTextures;                           // 0x02C8 (size: 0x10)
    ...
    TArray<ULandscapeComponent*> LandscapeComponents;                                 // 0x02F0 (size: 0x10)
    TArray<ULandscapeHeightfieldCollisionComponent*> CollisionComponents;             // 0x0300 (size: 0x10)
    TArray<UHierarchicalInstancedStaticMeshComponent*> FoliageComponents;             // 0x0310 (size: 0x10)
    ...
    TMap<UTexture2D*, ULandscapeWeightmapUsage*> WeightmapUsageMap;                   // 0x0548 (size: 0x50)
...
class ULandscapeComponent : public UPrimitiveComponent
{
    ...
    TArray<UMaterialInstanceConstant*> MaterialInstances;                             // 0x0488 (size: 0x10)
    TArray<UMaterialInstanceDynamic*> MaterialInstancesDynamic;                       // 0x0498 (size: 0x10)
    ...
    TArray<UTexture2D*> WeightmapTextures;                                            // 0x0550 (size: 0x10)
    ...
    TArray<UMaterialInterface*> MobileMaterialInterfaces;                             // 0x05E0 (size: 0x10)
    TArray<UTexture2D*> MobileWeightmapTextures;                                      // 0x05F0 (size: 0x10)
...
{
    TArray<ULandscapeLayerInfoObject*> ComponentLayerInfos;                           // 0x0450 (size: 0x10)
    ...
    TArray<UPhysicalMaterial*> CookedPhysicalMaterials;                               // 0x04E0 (size: 0x10)
...
class ULandscapeInfo : public UObject
{
    ...
    TArray<ALandscapeStreamingProxy*> Proxies;                                        // 0x0110 (size: 0x10)
...
class ULandscapeSplineSegment : public UObject
{
    ...
    TArray<FLandscapeSplineInterpPoint> Points;                                       // 0x0070 (size: 0x10)
    FBox Bounds;                                                                      // 0x0080 (size: 0x1C)
    TArray<USplineMeshComponent*> LocalMeshComponents;                                // 0x00A0 (size: 0x10)

}; // Size: 0xB0

class ULandscapeSplinesComponent : public UPrimitiveComponent
{
    TArray<ULandscapeSplineControlPoint*> ControlPoints;                              // 0x0450 (size: 0x10)
    TArray<ULandscapeSplineSegment*> Segments;                                        // 0x0460 (size: 0x10)
    TArray<UMeshComponent*> CookedForeignMeshComponents;                              // 0x0470 (size: 0x10)
