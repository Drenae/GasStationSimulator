#ifndef UE4SS_SDK_FuelPistol_HPP
#define UE4SS_SDK_FuelPistol_HPP

class AFuelPistol_C : public AFuelPistolBase
{
    ...
    FFuelPistol_CPistolInUse PistolInUse;                                             // 0x0290 (size: 0x10)
    void PistolInUse(bool PistolInUse);
    class AFuelEnter* Fuel Enter;                                                     // 0x02A0 (size: 0x8)
    class UWBP_FuelBeforeTanking_C* FuelBeforeWidget;                                 // 0x02A8 (size: 0x8)
    TMap<TSubclassOf<class AFuelEnter>, FRotator> CorrectnessRotations;               // 0x02B0 (size: 0x50)

    void AddPistolOffsetWhenConnected(class AFuelEnter* FuelEnter, class AActor* FuelPistol);
    ...
    void StopMiniGame();
    void StartMiniGame();
    void ExecuteUbergraph_FuelPistol(int32 EntryPoint);
