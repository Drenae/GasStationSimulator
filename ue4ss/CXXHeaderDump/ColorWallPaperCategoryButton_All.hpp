#ifndef UE4SS_SDK_ColorWallPaperCategoryButton_All_HPP
#define UE4SS_SDK_ColorWallPaperCategoryButton_All_HPP

class UColorWallPaperCategoryButton_All_C : public UUserWidget
{
    ...
    FColorWallPaperCategoryButton_All_COnClickedButton OnClickedButton;               // 0x02B0 (size: 0x10)
    ...
    void GamePadClick();
    void ExecuteUbergraph_ColorWallPaperCategoryButton_All(int32 EntryPoint);
