#ifndef UE4SS_SDK_WBP_UfoReset_HPP
#define UE4SS_SDK_WBP_UfoReset_HPP

class UWBP_UfoReset_C : public UUserWidget
{
    ...
    void ClickNo();
    void ConsumeLPM();
    void ExecuteUbergraph_WBP_UfoReset(int32 EntryPoint);
}; // Size: 0x2F0
