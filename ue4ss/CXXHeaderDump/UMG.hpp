...
{
    TArray<UObject*> Items;                                                           // 0x0108 (size: 0x10)
...
class UListView : public UListViewBase
{
    ...
    TArray<UObject*> ListItems;                                                       // 0x02E8 (size: 0x10)
...
{
    TArray<UPanelSlot*> Slots;                                                        // 0x0108 (size: 0x10)
...
class URichTextBlock : public UTextLayoutWidget
{
    ...
    TArray<TSubclassOf<class URichTextBlockDecorator>> DecoratorClasses;              // 0x0148 (size: 0x10)
    ...
    TArray<URichTextBlockDecorator*> InstanceDecorators;                              // 0x0648 (size: 0x10)
...
{
    TSet<TWeakObjectPtr<class UUserWidget>> WeakUserWidgets;                          // 0x0028 (size: 0x50)
...
class UUserWidget : public UWidget
{
    ...
    TArray<UUMGSequencePlayer*> ActiveSequencePlayers;                                // 0x01A0 (size: 0x10)
    class UUMGSequenceTickManager* AnimationTickManager;                              // 0x01B0 (size: 0x8)
    TArray<UUMGSequencePlayer*> StoppedSequencePlayers;                               // 0x01B8 (size: 0x10)
...
class UWidget : public UVisual
{
    ...
    TArray<UPropertyBinding*> NativeBindings;                                         // 0x00F8 (size: 0x10)
...
class UWidgetBlueprintGeneratedClass : public UBlueprintGeneratedClass
{
    ...
    TArray<UWidgetAnimation*> Animations;                                             // 0x0348 (size: 0x10)
