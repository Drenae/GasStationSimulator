...
{
    TArray<UAISenseConfig*> SensesConfig;                                             // 0x00B0 (size: 0x10)
...
class UAIPerceptionStimuliSourceComponent : public UActorComponent
{
    ...
    TArray<TSubclassOf<class UAISense>> RegisterAsSourceForSenses;                    // 0x00B8 (size: 0x10)
...
class UAISystem : public UAISystemBase
{
    ...
    TArray<UAIAsyncTaskBlueprintProxy*> AllProxyObjects;                              // 0x00B8 (size: 0x10)
...
{
    TArray<UBTNode*> NodeInstances;                                                   // 0x0128 (size: 0x10)
...
class UBlackboardComponent : public UActorComponent
{
    ...
    TArray<UBlackboardKeyType*> KeyInstances;                                         // 0x00E8 (size: 0x10)
