...
class UInteractiveTool : public UObject
{
    ...
    TArray<UObject*> ToolPropertyObjects;                                             // 0x0050 (size: 0x10)
...
class UInteractiveToolManager : public UObject
{
    ...
    TMap<FString, UInteractiveToolBuilder*> ToolBuilders;                             // 0x0090 (size: 0x50)
...
class UIntervalGizmo : public UInteractiveGizmo
{
    ...
    TArray<UPrimitiveComponent*> ActiveComponents;                                    // 0x0058 (size: 0x10)
    TArray<UInteractiveGizmo*> ActiveGizmos;                                          // 0x0068 (size: 0x10)
...
class UTransformGizmo : public UInteractiveGizmo
{
    ...
    TArray<UPrimitiveComponent*> ActiveComponents;                                    // 0x0100 (size: 0x10)
    TArray<UPrimitiveComponent*> NonuniformScaleComponents;                           // 0x0110 (size: 0x10)
    TArray<UInteractiveGizmo*> ActiveGizmos;                                          // 0x0120 (size: 0x10)
