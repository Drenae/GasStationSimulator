...
struct FMovieSceneRootEvaluationTemplateInstance
{
    ...
    TMap<FMovieSceneSequenceID, UObject*> DirectorInstances;                          // 0x0090 (size: 0x50)
...
class UMovieScene : public UMovieSceneSignedObject
{
    ...
    TMap<FName, FMovieSceneObjectBindingIDs> BindingGroups;                           // 0x0080 (size: 0x50)
    TArray<UMovieSceneTrack*> MasterTracks;                                           // 0x00D0 (size: 0x10)
...
class UMovieSceneFolder : public UObject
{
    ...
    TArray<UMovieSceneFolder*> ChildFolders;                                          // 0x0030 (size: 0x10)
    TArray<UMovieSceneTrack*> ChildMasterTracks;                                      // 0x0040 (size: 0x10)
...
{
    TArray<UMovieSceneSection*> SectionArray;                                         // 0x0090 (size: 0x10)
...
{
    TArray<UMovieSceneSection*> SectionArray;                                         // 0x00A0 (size: 0x10)
