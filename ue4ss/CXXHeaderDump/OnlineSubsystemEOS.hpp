...
class UEOSSettings : public URuntimeOptionsBase
{
    ...
    TArray<FString> AuthScopeFlags;                                                   // 0x0088 (size: 0x10)
    bool bUseEAS;                                                                     // 0x0098 (size: 0x1)
    bool bUseEOSConnect;                                                              // 0x0099 (size: 0x1)
    bool bMirrorStatsToEOS;                                                           // 0x009A (size: 0x1)
    bool bMirrorAchievementsToEOS;                                                    // 0x009B (size: 0x1)
    bool bUseEOSSessions;                                                             // 0x009C (size: 0x1)
    bool bMirrorPresenceToEAS;                                                        // 0x009D (size: 0x1)
