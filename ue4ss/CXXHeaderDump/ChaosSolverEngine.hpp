...
{
    TMap<UPrimitiveComponent*, FChaosHandlerSet> CollisionEventRegistrations;         // 0x01C8 (size: 0x50)
    TMap<UPrimitiveComponent*, FBreakEventCallbackWrapper> BreakEventRegistrations;   // 0x0218 (size: 0x50)
