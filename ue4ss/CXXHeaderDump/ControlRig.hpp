...
struct FAnimNode_ControlRig : public FAnimNode_ControlRigBase
{
    ...
    TMap<FName, FName> InputMapping;                                                  // 0x0210 (size: 0x50)
    TMap<FName, FName> OutputMapping;                                                 // 0x0260 (size: 0x50)
...
class AControlRigControlActor : public AActor
{
    ...
    TArray<UStaticMeshComponent*> Components;                                         // 0x0288 (size: 0x10)
    TArray<UMaterialInstanceDynamic*> Materials;                                      // 0x0298 (size: 0x10)
...
class UControlRig : public UObject
{
    ...
    TSoftObjectPtr<class UControlRigGizmoLibrary> GizmoLibrary;                       // 0x03B8 (size: 0x28)
    TMap<FName, FCachedPropertyPath> InputProperties;                                 // 0x03F0 (size: 0x50)
    TMap<FName, FCachedPropertyPath> OutputProperties;                                // 0x0440 (size: 0x50)
    ...
    TArray<UAssetUserData*> AssetUserData;                                            // 0x05C0 (size: 0x10)
...
class UControlRigGizmoLibrary : public UObject
{
    ...
    TSoftObjectPtr<class UMaterial> DefaultMaterial;                                  // 0x0090 (size: 0x28)
...
{
    TSoftObjectPtr<class UAnimSequence> LastExportedToAnimationSequence;              // 0x01C8 (size: 0x28)
    TSoftObjectPtr<class USkeletalMesh> LastExportedUsingSkeletalMesh;                // 0x01F0 (size: 0x28)
...
class UMovieSceneControlRigParameterSection : public UMovieSceneParameterSection
{
    ...
    TMap<FName, FChannelMapInfo> ControlChannelMap;                                   // 0x0210 (size: 0x50)
