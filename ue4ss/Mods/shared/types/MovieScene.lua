...
---@field SequenceActor AActor
---@field SequenceActorInterface TScriptInterface<IMovieSceneSequenceActor>
local FMovieSceneSequenceActorPointers = {}
...
local IMovieSceneFloatDecomposer = {}
...
local IMovieSceneSceneComponentImpersonator = {}


---@class IMovieSceneSequenceActor : IInterface
local IMovieSceneSequenceActor = {}
...
---@field SequenceActors TArray<FMovieSceneSequenceActorPointers>
---@field Linker UMovieSceneEntitySystemLinker
