...
---@class ABigStandCarCare_lvl1_C : A00_Stand_C
...
local ABigStandCarCare_lvl1_C = {}

---@param DeltaSeconds float
function ABigStandCarCare_lvl1_C:ReceiveTick(DeltaSeconds) end
function ABigStandCarCare_lvl1_C:ReceiveDestroyed() end
function ABigStandCarCare_lvl1_C:ReceiveBeginPlay() end
---@param EntryPoint int32
function ABigStandCarCare_lvl1_C:ExecuteUbergraph_BigStandCarCare_lvl1(EntryPoint) end
