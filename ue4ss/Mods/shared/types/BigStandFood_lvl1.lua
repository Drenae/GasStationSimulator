...
---@class ABigStandFood_lvl1_C : A00_Stand_C
...
---@field Spline18 USplineComponent
...
---@field Spline19 USplineComponent
---@field Spline1 USplineComponent
local ABigStandFood_lvl1_C = {}

function ABigStandFood_lvl1_C:ReceiveBeginPlay() end
function ABigStandFood_lvl1_C:ReceiveDestroyed() end
---@param DeltaSeconds float
function ABigStandFood_lvl1_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function ABigStandFood_lvl1_C:ExecuteUbergraph_BigStandFood_lvl1(EntryPoint) end
