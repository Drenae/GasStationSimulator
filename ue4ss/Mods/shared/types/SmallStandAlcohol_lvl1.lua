...
---@class ASmallStandAlcohol_lvl1_C : A00_Stand_C
...
local ASmallStandAlcohol_lvl1_C = {}

function ASmallStandAlcohol_lvl1_C:ReceiveBeginPlay() end
function ASmallStandAlcohol_lvl1_C:ReceiveDestroyed() end
---@param DeltaSeconds float
function ASmallStandAlcohol_lvl1_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function ASmallStandAlcohol_lvl1_C:ExecuteUbergraph_SmallStandAlcohol_lvl1(EntryPoint) end
