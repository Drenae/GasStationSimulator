...
---@class ABigStandAlcohol_lvl1_C : A00_Stand_C
...
local ABigStandAlcohol_lvl1_C = {}

---@param DeltaSeconds float
function ABigStandAlcohol_lvl1_C:ReceiveTick(DeltaSeconds) end
function ABigStandAlcohol_lvl1_C:ReceiveDestroyed() end
function ABigStandAlcohol_lvl1_C:ReceiveBeginPlay() end
---@param EntryPoint int32
function ABigStandAlcohol_lvl1_C:ExecuteUbergraph_BigStandAlcohol_lvl1(EntryPoint) end
