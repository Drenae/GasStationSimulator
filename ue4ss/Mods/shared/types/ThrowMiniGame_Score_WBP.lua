...
---@class UThrowMiniGame_Score_WBP_C : UUserWidget
...
local UThrowMiniGame_Score_WBP_C = {}

function UThrowMiniGame_Score_WBP_C:Construct() end
---@param MyGeometry FGeometry
---@param InDeltaTime float
function UThrowMiniGame_Score_WBP_C:Tick(MyGeometry, InDeltaTime) end
function UThrowMiniGame_Score_WBP_C:Destruct() end
function UThrowMiniGame_Score_WBP_C:AchievementCheck() end
---@param EntryPoint int32
function UThrowMiniGame_Score_WBP_C:ExecuteUbergraph_ThrowMiniGame_Score_WBP(EntryPoint) end
